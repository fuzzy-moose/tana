...
func lookup(service *metadata.Service) http.HandlerFunc {
...
func requestFetch(service *metadata.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var input struct {
...
func getFetchJob(service *metadata.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
