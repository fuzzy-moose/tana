...
type Repository interface {
	...
	Create(ctx context.Context, libraryID, path string, kind Kind, files []string) (Source, error)
	Get(ctx context.Context, id string) (Source, error)
	List(ctx context.Context, libraryID string) ([]Source, error)
	Files(ctx context.Context, id string) ([]File, error)
